...
static void initialise_nav_next_leg_ui(void) {
	rowIndex=0;
	rowSpace = 32;
	...
	set_nav_next_leg_text_layer( NEXTLEGTWSE); //22
	set_nav_next_leg_text_layer( NEXTLEGAWA); //23
	set_nav_next_leg_text_layer( NEXTLEGAWS);//24	
