...
void current_course_config_provider() {
 // single click / repeat-on-hold config:
  ...
  window_single_click_subscribe(BUTTON_ID_SELECT, show_nav_courses_menu);
  //window_single_click_subscribe(BUTTON_ID_UP, show_nav_courses_menu); //modifies behaviour
